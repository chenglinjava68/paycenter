...
public class LogUtil {
	...
	private static final Logger GATELOG = LoggerFactory.getLogger(LogUtil.class);
	private static final Logger GATELOG_ERROR = LoggerFactory.getLogger(LogUtil.class);
	private static final Logger GATELOG_MESSAGE = LoggerFactory.getLogger(LogUtil.class);
