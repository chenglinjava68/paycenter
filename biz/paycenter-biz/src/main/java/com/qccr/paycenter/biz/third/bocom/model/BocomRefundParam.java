...
/**
 * @author dhj
 * @since $Revision:1.0.0, $Date: 2016/8/11 18:06 $
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "transData")
@XmlType
public class BocomRefundParam {
    ...
    private  String authNo;  //原授权号

    @XmlElement(name = "invioceNo")
    private  String invioceNo ; //票据号，6位批次号+6位凭证号+6位原批次号+6位原凭证号
